...
FOR %%x IN ("D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\php\php.exe"
GOTO :INSTALLED
