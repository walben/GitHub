...
#!perl
#line 29
    eval 'exec D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\Home\Tom\Archives\GitHub\H-pverkefni-fyrir-CNA\core\Varaverkefni_Tomma\perl\bin\perl.exe';
